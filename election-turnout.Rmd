...
ggsave("turnout_votes_by_party_all.png")
```
...
ggsave("turnout_votes_no_house.png")
```
...
ggsave("turnout_by_winning_party.png")
```
...
Want to run the notebook? Hit the [GitHub Repo]()
